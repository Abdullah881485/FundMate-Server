...
const serviceAccount = require("./fundmate-project-firebase-adminsdk-fbsvc-600454ed5f.json");
...
async function run() {
    try {
        ...
        app.get("/allLoan", async (req, res) => {
            ...
            const cursor = loanCollection.find().limit(Number(limit)).skip(Number(skip));
            const result = await cursor.toArray();
        ...
        app.get("/allApplication", verifyFirebaseToken, async (req, res) => {
        ...
        app.get("/statusByApplication", verifyFirebaseToken, async (req, res) => {
        ...
        app.post("/allApplication", verifyFirebaseToken, async (req, res) => {
            const newApplication = req.body;
            const result = await applicationCollection.insertOne(newApplication)
            res.send(result)
        })

        app.get("/manageLoan", verifyFirebaseToken, async (req, res) => {
